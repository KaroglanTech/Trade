...
import org.github.tollainmear.trade.commandexecutor.MainExecutor;
import org.github.tollainmear.trade.commandexecutor.ReloadExecutor;
import org.github.tollainmear.trade.commandexecutor.VersionExecutor;
import org.github.tollainmear.trade.utils.Translator;
import org.karoglan.tollainmear.trade.commandexecutor.*;
...
//                .build();
    ...
    public void init(Trade plugin) {
        ...
        cmdManager.register(plugin, this.get(), "kse", "sign", "trade", "se");
